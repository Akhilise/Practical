...
const Patient = ({route}) => {
     ...
     const button = route.params.buttonCount;
  return (
    <View style={styles.View}>
      <View style={styles.container}>
        ...
        <View style={styles.TextContainer}>
          ...
          <RatingStar rating={patient.rating} />
        </View>
      </View>
      ...
      <View style={styles.container2}>
        <View style={styles.detail}>
          ...
          <Text style={styles.text}>{patient.date}</Text>
        </View>
        <View style={styles.detail}>
          <Icon
            type={'MaterialIcons'}
            ...
            color={'grey'}
          />
          <Text style={styles.text}>{patient.time}</Text>
        </View>
        <View style={styles.detail}>
          <Icon type={'MaterialIcons'} name={'menu'} size={25} color={'grey'} />
          <Text style={styles.text}>{patient.description}</Text>
        </View>
      </View>
